  ...
  <body style="background-color: black;">
    <nav class="navbar navbar-expand-lg" style="background-color: #58A0C8 ;">
      ...
      <div class="container-fluid">
        ...
        <a class="navbar-brand"><img src="img/peliculas/vaflog1.jpg" class="d-block w-100" alt="..."> </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="peliculas2.php?categoria=peliculas">PELICULAS</a>
            ...
            <li class="nav-item">
              <a class="nav-link" href="creditos2.php?categoria=creditos">CREDITOS</a>
            </li>
