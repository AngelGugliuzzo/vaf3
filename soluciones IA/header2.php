...
<html lang="en">
  <head>
    ...
    <title>biblioteca de starwars</title>
    <!--1 link css-->
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#">biblioteca star wars</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          ...
          <a class="nav-link active" aria-current="page" href="previews.php?categoria=personajes">personajes</a>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="previews.php?categoria=naves">naves</a>
        </li>
